...
namespace MusicDatabase.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ArtistId,ArtistName,Country,RealName,IsGroup,StartedYear")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ArtistId,ArtistName,Country,RealName,IsGroup,StartedYear")] Artist artist)
        {
