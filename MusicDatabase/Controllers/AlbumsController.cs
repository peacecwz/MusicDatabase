...
namespace MusicDatabase.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AlbumId,AlbumName,Country,Barcode,IsSingle,ArtistId,ReleaseYear")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlbumId,AlbumName,Country,Barcode,IsSingle,ArtistId,ReleaseYear")] Album album)
        {
            if (id != album.AlbumId)
            {
                return NotFound();
